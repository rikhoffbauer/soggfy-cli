...
/**
 * Calendar component styled for this UI kit.
 *
 * @example
 * ```tsx
 * <Calendar mode="single" selected={new Date()} className="rounded-lg border" />
 * ```
 */
function Calendar({
  className,
...
/**
 * CalendarDayButton component styled for this UI kit.
 *
 * @example
 * ```tsx
 * <Calendar mode="single" selected={new Date()} className="rounded-lg border" />
