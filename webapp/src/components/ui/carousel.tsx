 ...
 *             <div className="bg-muted flex h-32 items-center justify-center rounded-lg text-sm">
 *               Slide {index + 1}
 *             </div>
 *           </CarouselItem>
 *         ))}
...
/**
 * CarouselContext component styled for this UI kit.
 *
 * @example
 * ```tsx
 * <Carousel className="w-full max-w-xs">
...
/**
 * Carousel component styled for this UI kit.
 *
 * @example
 * ```tsx
 * <Carousel className="w-full max-w-xs">
...
/**
 * CarouselContent component styled for this UI kit.
 *
 * @example
 * ```tsx
 * <Carousel className="w-full max-w-xs">
...
/**
 * CarouselItem component styled for this UI kit.
 *
 * @example
 * ```tsx
 * <Carousel className="w-full max-w-xs">
...
/**
 * CarouselPrevious component styled for this UI kit.
 *
 * @example
 * ```tsx
 * <Carousel className="w-full max-w-xs">
...
/**
 * CarouselNext component styled for this UI kit.
 *
 * @example
 * ```tsx
 * <Carousel className="w-full max-w-xs">
