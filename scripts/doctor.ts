...
import { readSpotifyBundleVersion, SUPPORTED_SPOTIFY_VERSION } from "../src/core/spotify-runtime";
...
add("spotify:version", systemVersion === SUPPORTED_SPOTIFY_VERSION, `${systemVersion ?? "unknown"} (supported: ${SUPPORTED_SPOTIFY_VERSION})`);
...
add("workspace:version", patchedVersion === SUPPORTED_SPOTIFY_VERSION, `${patchedVersion ?? "unknown"} (supported: ${SUPPORTED_SPOTIFY_VERSION})`);
